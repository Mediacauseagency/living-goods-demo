!function(){function e(e,t,i){var n;-1!==M.indexOf(e)&&(t.namespace=P);var r=!1;if(t.namespace&&(r=t.namespace,delete t.namespace),r)n=document.createElementNS(r,e);else{if(e===G)return document.createComment(t.comment);n=document.createElement(e)}for(var o in t)if(t.hasOwnProperty(o)){var s=o.toLowerCase(),a=t[o];if("classname"===s&&(s="class",o="class"),"htmlFor"===o&&(o="for"),-1!==R.indexOf(s))if("true"===a)a=s;else if("false"===a)continue;"on"===s.slice(0,2)?n[o]=a:r?"xlink:href"===o?n.setAttributeNS(D,o,a):/^xmlns($|:)/i.test(o)||n.setAttributeNS(null,o,a):n.setAttribute(o,a)}return g(n,i),n}function t(e,i){i=i||ue;var n;return pe?(n=window.requestIdleCallback(function(n){if(n.timeRemaining()<=10&&!n.didTimeout)return t(e,i);e(n)},i),window.cancelIdleCallback.bind(window,n)):de?(n=setTimeout(e,0),clearTimeout.bind(window,n)):void 0}function i(e){e&&he(e)}function n(e){if(!(this instanceof n))return new n(e);this._name=e||"nanobus",this._starListeners=[],this._listeners={}}function r(e,t,i){e[i]!==t[i]&&(t[i]=e[i],e[i]?t.setAttribute(i,""):t.removeAttribute(i))}function o(e,t){return t?e?e.isSameNode&&e.isSameNode(t)?t:e.tagName!==t.tagName?e:(_e(e,t),function(e,t){for(var i,n,r,a,l=0,c=0;i=t.childNodes[c],n=e.childNodes[c-l],i||n;c++)if(n)if(i)if(s(n,i))(r=o(n,i))!==i&&(t.replaceChild(r,i),l++);else{a=null;for(var u=c;u<t.childNodes.length;u++)if(s(t.childNodes[u],n)){a=t.childNodes[u];break}a?((r=o(n,a))!==a&&l++,t.insertBefore(r,i)):n.id||i.id?(t.insertBefore(n,i),l++):(r=o(n,i))!==i&&(t.replaceChild(r,i),l++)}else t.appendChild(n),l++;else t.removeChild(i),c--}(e,t),t):null:e}function s(e,t){return e.id?e.id===t.id:e.isSameNode?e.isSameNode(t):e.tagName===t.tagName&&e.type===Ae&&e.nodeValue===t.nodeValue}function a(){if(!(this instanceof a))return new a;this.trie={nodes:{}}}function l(e){function t(e){for(var t=new Array(arguments.length),r=1;r<t.length;r++)t[r]=arguments[r];var o=n.match(e);if(o&&o.cb){t[0]=o.params;var s=o.cb;return s.apply(s,t)}var a=n.match(i);if(a&&a.cb){t[0]=a.params;var l=a.cb;return l.apply(l,t)}throw new Error("route '"+e+"' did not match")}if(!(this instanceof l))return new l(e);var i=(e||"").replace(/^\//,""),n=Ce();return t._trie=n,t.emit=t,t.on=function(e,i){return e=e||"/",i.route=e,i&&i._wayfarer&&i._trie?n.mount(e,i._trie.trie):n.create(e).cb=i,t},t._wayfarer=!0,t}function c(e){if(!(this instanceof c))return new c(e);e=e||{};var t=this;this._events={DOMCONTENTLOADED:"DOMContentLoaded",DOMTITLECHANGE:"DOMTitleChange",REPLACESTATE:"replaceState",PUSHSTATE:"pushState",NAVIGATE:"navigate",POPSTATE:"popState",RENDER:"render"},this._historyEnabled=void 0===e.history||e.history,this._hrefEnabled=void 0===e.href||e.href,this._hasWindow="undefined"!=typeof window,this._createLocation=ye,this._loaded=!1,this._tree=null,this.router=Ve({curry:!0}),this.emitter=ge("choo.emit");var i={events:this._events};this._hasWindow?(this.state=window.initialState?ke(window.initialState,i):i,delete window.initialState):this.state=i,this._hasWindow&&(this.state.title=document.title),this.emitter.prependListener(this._events.DOMTITLECHANGE,function(e){t.state.title=e,t._hasWindow&&(document.title=e)})}var u=/\n[\s]+$/,d=/^\n[\s]+/,p=/[\s]+$/,h=/^[\s]+/,f=/[\n\s]+/g,m=["a","abbr","b","bdi","bdo","br","cite","data","dfn","em","i","kbd","mark","q","rp","rt","rtc","ruby","s","amp","small","span","strong","sub","sup","time","u","var","wbr"],v=["code","pre"],g=function e(t,i){if(Array.isArray(i))for(var n,r,o=t.nodeName.toLowerCase(),s=!1,a=0,l=i.length;a<l;a++){var c=i[a];if(Array.isArray(c))e(t,c);else{("number"==typeof c||"boolean"==typeof c||"function"==typeof c||c instanceof Date||c instanceof RegExp)&&(c=c.toString());var g=t.childNodes[t.childNodes.length-1];if("string"==typeof c)s=!0,g&&"#text"===g.nodeName?g.nodeValue+=c:(c=document.createTextNode(c),t.appendChild(c),g=c),a===l-1&&(s=!1,-1===m.indexOf(o)&&-1===v.indexOf(o)?""===(n=g.nodeValue.replace(d,"").replace(p,"").replace(u,"").replace(f," "))?t.removeChild(g):g.nodeValue=n:-1===v.indexOf(o)&&(r=0===a?"":" ",n=g.nodeValue.replace(d,r).replace(h," ").replace(p,"").replace(u,"").replace(f," "),g.nodeValue=n));else if(c&&c.nodeType){s&&(s=!1,-1===m.indexOf(o)&&-1===v.indexOf(o)?""===(n=g.nodeValue.replace(d,"").replace(u,"").replace(f," "))?t.removeChild(g):g.nodeValue=n:-1===v.indexOf(o)&&(n=g.nodeValue.replace(h," ").replace(d,"").replace(u,"").replace(f," "),g.nodeValue=n));var b=c.nodeName;b&&(o=b.toLowerCase()),t.appendChild(c)}}}},b={class:"className",for:"htmlFor","http-equiv":"httpEquiv"},w=1,y=2,x=3,$=4,_=5,A=6,N=7,L=8,T=9,k=10,S=11,E=12,O=13;Object.prototype.hasOwnProperty;var C=RegExp("^("+["area","base","basefont","bgsound","br","col","command","embed","frame","hr","img","input","isindex","keygen","link","meta","param","source","track","wbr","!--","animate","animateTransform","circle","cursor","desc","ellipse","feBlend","feColorMatrix","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","font-face-format","font-face-name","font-face-uri","glyph","glyphRef","hkern","image","line","missing-glyph","mpath","path","polygon","polyline","rect","set","stop","tref","use","view","vkern"].join("|")+")(?:[.#][a-zA-Z0-9\x7f-\uffff_:-]+)*$"),I={},P="http://www.w3.org/2000/svg",D="http://www.w3.org/1999/xlink",R=["autofocus","checked","defaultchecked","disabled","formnovalidate","indeterminate","readonly","required","selected","willvalidate"],G="!--",M=["svg","altGlyph","altGlyphDef","altGlyphItem","animate","animateColor","animateMotion","animateTransform","circle","clipPath","color-profile","cursor","defs","desc","ellipse","feBlend","feColorMatrix","feComponentTransfer","feComposite","feConvolveMatrix","feDiffuseLighting","feDisplacementMap","feDistantLight","feFlood","feFuncA","feFuncB","feFuncG","feFuncR","feGaussianBlur","feImage","feMerge","feMergeNode","feMorphology","feOffset","fePointLight","feSpecularLighting","feSpotLight","feTile","feTurbulence","filter","font","font-face","font-face-format","font-face-name","font-face-src","font-face-uri","foreignObject","g","glyph","glyphRef","hkern","image","line","linearGradient","marker","mask","metadata","missing-glyph","mpath","path","pattern","polygon","polyline","radialGradient","rect","set","stop","switch","symbol","text","textPath","title","tref","tspan","use","view","vkern"];(I=function(e,t){function i(e){return"function"==typeof e?e:"string"==typeof e?e:e&&"object"==typeof e?e:n("",e)}t||(t={});var n=t.concat||function(e,t){return String(e)+String(t)};return!1!==t.attrToProp&&(e=function(e){return function(t,i,n){for(var r in i)r in b&&(i[b[r]]=i[r],delete i[r]);return e(t,i,n)}}(e)),function(r){function o(e){var i=[];s===N&&(s=$);for(var n=0;n<e.length;n++){var r=e.charAt(n);s===w&&"<"===r?(a.length&&i.push([w,a]),a="",s=y):">"!==r||function(e){return e===T||e===k}(s)||s===O?s===O&&/-$/.test(a)&&"-"===r?(t.comments&&i.push([L,a.substr(0,a.length-1)],[x]),a="",s=w):s===y&&/^!--$/.test(a)?(t.comments&&i.push([y,a],[_,"comment"],[S]),a=r,s=O):s===w||s===O?a+=r:s===y&&/\s/.test(r)?(i.push([y,a]),a="",s=$):s===y?a+=r:s===$&&/[^\s"'=/]/.test(r)?(s=_,a=r):s===$&&/\s/.test(r)?(a.length&&i.push([_,a]),i.push([E])):s===_&&/\s/.test(r)?(i.push([_,a]),a="",s=A):s===_&&"="===r?(i.push([_,a],[S]),a="",s=N):s===_?a+=r:s!==A&&s!==$||"="!==r?s!==A&&s!==$||/\s/.test(r)?s===N&&'"'===r?s=k:s===N&&"'"===r?s=T:s===k&&'"'===r?(i.push([L,a],[E]),a="",s=$):s===T&&"'"===r?(i.push([L,a],[E]),a="",s=$):s!==N||/\s/.test(r)?s===L&&/\s/.test(r)?(i.push([L,a],[E]),a="",s=$):s!==L&&s!==T&&s!==k||(a+=r):(s=L,n--):(i.push([E]),/[\w-]/.test(r)?(a+=r,s=_):s=$):(i.push([S]),s=N):(s===y?i.push([y,a]):s===_?i.push([_,a]):s===L&&a.length&&i.push([L,a]),i.push([x]),a="",s=w)}return s===w&&a.length?(i.push([w,a]),a=""):s===L&&a.length?(i.push([L,a]),a=""):s===k&&a.length?(i.push([L,a]),a=""):s===T&&a.length?(i.push([L,a]),a=""):s===_&&(i.push([_,a]),a=""),i}for(var s=w,a="",l=arguments.length,c=[],u=0;u<r.length;u++)if(u<l-1){var d=arguments[u+1],p=o(r[u]),h=s;h===k&&(h=L),h===T&&(h=L),h===N&&(h=L),h===$&&(h=_),p.push([0,h,d]),c.push.apply(c,p)}else c.push.apply(c,o(r[u]));for(var f=[null,{},[]],m=[[f,-1]],u=0;u<c.length;u++){var v=m[m.length-1][0],g=(p=c[u])[0];if(g===y&&/^\//.test(p[1]))R=m[m.length-1][1],m.length>1&&(m.pop(),m[m.length-1][0][2][R]=e(v[0],v[1],v[2].length?v[2]:void 0));else if(g===y){var b=[p[1],{},[]];v[2].push(b),m.push([b,v[2].length-1])}else if(g===_||0===g&&p[1]===_){for(var I,P="";u<c.length;u++)if(c[u][0]===_)P=n(P,c[u][1]);else{if(0!==c[u][0]||c[u][1]!==_)break;if("object"!=typeof c[u][2]||P)P=n(P,c[u][2]);else for(I in c[u][2])c[u][2].hasOwnProperty(I)&&!v[1][I]&&(v[1][I]=c[u][2][I])}c[u][0]===S&&u++;for(var D=u;u<c.length;u++)if(c[u][0]===L||c[u][0]===_)v[1][P]?v[1][P]=n(v[1][P],c[u][1]):v[1][P]=i(c[u][1]);else{if(0!==c[u][0]||c[u][1]!==L&&c[u][1]!==_){!P.length||v[1][P]||u!==D||c[u][0]!==x&&c[u][0]!==E||(v[1][P]=P.toLowerCase()),c[u][0]===x&&u--;break}v[1][P]?v[1][P]=n(v[1][P],c[u][2]):v[1][P]=i(c[u][2])}}else if(g===_)v[1][p[1]]=!0;else if(0===g&&p[1]===_)v[1][p[2]]=!0;else if(g===x){if(function(e){return C.test(e)}(v[0])&&m.length){var R=m[m.length-1][1];m.pop(),m[m.length-1][0][2][R]=e(v[0],v[1],v[2].length?v[2]:void 0)}}else if(0===g&&p[1]===w)void 0===p[2]||null===p[2]?p[2]="":p[2]||(p[2]=n("",p[2])),Array.isArray(p[2][0])?v[2].push.apply(v[2],p[2]):v[2].push(p[2]);else if(g===w)v[2].push(p[1]);else if(g!==S&&g!==E)throw new Error("unhandled: "+g)}if(f[2].length>1&&/^\s*$/.test(f[2][0])&&f[2].shift(),f[2].length>2||2===f[2].length&&/\S/.test(f[2][1]))throw new Error("multiple root elements must be wrapped in an enclosing tag");return Array.isArray(f[2][0])&&"string"==typeof f[2][0][0]&&Array.isArray(f[2][0][2])&&(f[2][0]=e(f[2][0][0],f[2][0][1],f[2][0][2])),f[2][0]}}(e,{comments:!0})).default=I,I.createElement=e;var V=I,q=V`<div class='flex flex-wrap'>${[{name:"--blue-1",color:"#44ade2"},{name:"--blue-2",color:"#0281a4"},{name:"--blue-3",color:"#014f84"},{name:"--orange-1",color:"#f47a44"},{name:"--grey-1",color:"#f2f2f2"},{name:"--black",color:"#313334"}].map(e=>V`
...
`)}</div>`;const B=V`
  <div class='flex flex-wrap'>
    ${["btn--orange","btn--blue","btn--white"].map(e=>V`
...
`,j=V`
  <div class='flex flex-wrap px-05'>
    ${["First name","Last name","Email"].map(e=>V`
...
`,J=e=>{let t="";for(let i=0;i<e;i++)t+="The quick brown fox jumps over the lazy dog. ";return t};const Y=J(1);var Q=function(e){return e.replace(/\W+/g," ").trim().replace(/\s/g,"-").toLowerCase()};const ee=[{title:"Colors",view:q},{title:"Form elements",view:K},{title:"Icons",view:X},{title:"Typography",view:V`
  <div class='px-1'>
    <p class='mt-0'>We are using <strong>Merriweather Sans</strong>.</p>

    <div class='pl-1 pt-1'>
      ${[{className:"",title:"400"},{className:"italic",title:"400 italic"},{className:"bold",title:"700"},{className:"bold italic",title:"700 italic"},{className:"x-bold",title:"800"},{className:"x-bold italic",title:"800 italic"}].map(e=>V`
  <div class='mb-2'>
...
`;var ie=V`
  <nav class='container p-1 topNav flex flex-align-center'>
    ...
    <ul class='list-reset m-0 flex flex-wrap flex-justify-flex-end flex-grow-1'>
      ${[{title:"What we do",url:"#"},{title:"Impact",url:"#"},{title:"Who we are",url:"#"},{title:"Insights",url:"#"},{title:"Donate",url:"#",highlight:!0},{title:"Get Updates",url:"#",highlight:!0}].map(e=>V`
  <li>
...
`;var ne=({title:e,imgUrl:t,text:i,link:n,btnText:r,direction:o})=>V`
  <div data-in-view='false' class='container clearfix px-1 relative textBoxOverImage textBoxOverImage--${o}'>
    <div class=' textBoxOverImage__image'>
      <div class='aspect aspect-2x1'>
        <div class='bg-cover bg-grey-1' style='background-image: url(${t})'></div>
      </div>
    </div>
...
`,ae=["https://i.ytimg.com/vi/Wg8ZX62XpmY/maxresdefault.jpg","http://www.goodventures.org/images/organizations/Living-Goods-2.jpeg","https://www.openphilanthropy.org/sites/default/files/styles/medium/public/grants/Living-Goods-2014.jpeg?itok=sCuPBCZT","https://i.vimeocdn.com/video/532001913_780x439.jpg","https://www.lemelson.org/sites/default/files/images/GOOD%20Living%20Goods%20Oct_%202010_05.jpg"];var le,ce=function(e){var t=document.readyState;if("complete"===t||"interactive"===t)return setTimeout(e,0);document.addEventListener("DOMContentLoaded",function(){e()})},ue={},de="undefined"!=typeof window,pe=de&&window.requestIdleCallback,he=t,fe=!0;try{le=window.performance,fe="true"===window.localStorage.DISABLE_NANOTIMING||!le.mark}catch(e){}var me=function(e){function t(t){var i="end-"+n+"-"+e;le.mark(i),he(function(){var o=e+" ["+n+"]";le.measure(o,r,i),le.clearMarks(r),le.clearMarks(i),t&&t(e)})}if(fe)return i;var n=(100*le.now()).toFixed(),r="start-"+n+"-"+e;return le.mark(r),t.uuid=n,t},ve=function(e,t,i){var n,r=e.length;if(!(t>=r||0===i)){var o=r-(i=t+i>r?r-t:i);for(n=t;n<o;++n)e[n]=e[n+i];e.length=o}},ge={};ge=n,n.prototype.emit=function(e,t){var i=me(this._name+"('"+e+"')"),n=this._listeners[e];return n&&n.length>0&&this._emit(this._listeners[e],t),this._starListeners.length>0&&this._emit(this._starListeners,e,t,i.uuid),i(),this},n.prototype.on=n.prototype.addListener=function(e,t){return"*"===e?this._starListeners.push(t):(this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].push(t)),this},n.prototype.prependListener=function(e,t){return"*"===e?this._starListeners.unshift(t):(this._listeners[e]||(this._listeners[e]=[]),this._listeners[e].unshift(t)),this},n.prototype.once=function(e,t){function i(){t.apply(n,arguments),n.removeListener(e,i)}var n=this;return this.on(e,i),this},n.prototype.prependOnceListener=function(e,t){function i(){t.apply(n,arguments),n.removeListener(e,i)}var n=this;return this.prependListener(e,i),this},n.prototype.removeListener=function(e,t){function i(e,t){if(e){var i=e.indexOf(t);return-1!==i?(ve(e,i,1),!0):void 0}}return"*"===e?(this._starListeners=this._starListeners.slice(),i(this._starListeners,t)):(void 0!==this._listeners[e]&&(this._listeners[e]=this._listeners[e].slice()),i(this._listeners[e],t))},n.prototype.removeAllListeners=function(e){return e?"*"===e?this._starListeners=[]:this._listeners[e]=[]:(this._starListeners=[],this._listeners={}),this},n.prototype.listeners=function(e){var t="*"!==e?this._listeners[e]:this._starListeners,i=[];if(t)for(var n=t.length,r=0;r<n;r++)i.push(t[r]);return i},n.prototype._emit=function(e,t,i,n){if(void 0!==e){void 0===i&&(i=t,t=null);for(var r=e.length,o=0;o<r;o++){var s=e[o];t?void 0!==n?s(t,i,n):s(t,i):s(i)}}};var be=/[noopener|noreferrer] [noopener|noreferrer]/,we=/^[\w-_]+:/,ye=function(){return window.location.pathname.replace(/\/$/,"")+window.location.hash.replace(/^#/,"/")},xe=["onclick","ondblclick","onmousedown","onmouseup","onmouseover","onmousemove","onmouseout","onmouseenter","onmouseleave","ontouchcancel","ontouchend","ontouchmove","ontouchstart","ondragstart","ondrag","ondragenter","ondragleave","ondragover","ondrop","ondragend","onkeydown","onkeypress","onkeyup","onunload","onabort","onerror","onresize","onscroll","onselect","onchange","onsubmit","onreset","onfocus","onblur","oninput","oncontextmenu","onfocusin","onfocusout"],$e=xe.length,_e=function(e,t){var i=e.nodeType,n=e.nodeName;1===i&&function(e,t){for(var i=t.attributes,n=e.attributes,r=null,o=null,s=null,a=null,l=n.length-1;l>=0;--l)a=n[l],s=a.name,r=a.namespaceURI,o=a.value,r?(s=a.localName||s,t.getAttributeNS(r,s)!==o&&t.setAttributeNS(r,s,o)):t.hasAttribute(s)?t.getAttribute(s)!==o&&("null"===o||"undefined"===o?t.removeAttribute(s):t.setAttribute(s,o)):t.setAttribute(s,o);for(var c=i.length-1;c>=0;--c)!1!==(a=i[c]).specified&&(s=a.name,(r=a.namespaceURI)?(s=a.localName||s,e.hasAttributeNS(r,s)||t.removeAttributeNS(r,s)):e.hasAttributeNS(null,s)||t.removeAttribute(s))}(e,t),3!==i&&8!==i||t.nodeValue!==e.nodeValue&&(t.nodeValue=e.nodeValue),"INPUT"===n?function(e,t){var i=e.value,n=t.value;r(e,t,"checked"),r(e,t,"disabled"),i!==n&&(t.setAttribute("value",i),t.value=i),"null"===i&&(t.value="",t.removeAttribute("value")),e.hasAttributeNS(null,"value")?"range"===t.type&&(t.value=i):t.removeAttribute("value")}(e,t):"OPTION"===n?function(e,t){r(e,t,"selected")}(e,t):"TEXTAREA"===n&&function(e,t){var i=e.value;if(i!==t.value&&(t.value=i),t.firstChild&&t.firstChild.nodeValue!==i){if(""===i&&t.firstChild.nodeValue===t.placeholder)return;t.firstChild.nodeValue=i}}(e,t),function(e,t){for(var i=0;i<$e;i++){var n=xe[i];e[n]?t[n]=e[n]:t[n]&&(t[n]=void 0)}}(e,t)},Ae=3,Ne=function(e,t){return o(t,e)},Le=new RegExp("([^?=&]+)(=([^&]*))?","g"),Te=function(e){var t={};return e.replace(/^.*\?/,"").replace(Le,function(e,i,n,r){t[window.decodeURIComponent(i)]=window.decodeURIComponent(r)}),t},ke=function(){for(var e={},t=0;t<arguments.length;t++){var i=arguments[t];for(var n in i)Se.call(i,n)&&(e[n]=i[n])}return e},Se=Object.prototype.hasOwnProperty,Ee=function(e){for(var t=1;t<arguments.length;t++){var i=arguments[t];for(var n in i)Oe.call(i,n)&&(e[n]=i[n])}return e},Oe=Object.prototype.hasOwnProperty,Ce={};Ce=a,a.prototype.create=function(e){function t(e,n){var r=i.hasOwnProperty(e)&&i[e];if(!1===r)return n;var o=null;return/^:|^\*/.test(r)?(n.nodes.hasOwnProperty("$$")?o=n.nodes.$$:(o={nodes:{}},n.nodes.$$=o),"*"===r[0]&&(n.wildcard=!0),n.name=r.replace(/^:|^\*/,"")):n.nodes.hasOwnProperty(r)?o=n.nodes[r]:(o={nodes:{}},n.nodes[r]=o),t(e+1,o)}var i=e.replace(/^\//,"").split("/");return t(0,this.trie)},a.prototype.match=function(e){function t(e,r){if(void 0!==r){var o=i[e];if(void 0===o)return r;if(r.nodes.hasOwnProperty(o))return t(e+1,r.nodes[o]);if(r.name){try{n[r.name]=decodeURIComponent(o)}catch(i){return t(e,void 0)}return t(e+1,r.nodes.$$)}if(r.wildcard){try{n.wildcard=decodeURIComponent(i.slice(e).join("/"))}catch(i){return t(e,void 0)}return r.nodes.$$}return t(e+1)}}var i=e.replace(/^\//,"").split("/"),n={},r=t(0,this.trie);if(r)return r=ke(r),r.params=n,r},a.prototype.mount=function(e,t){var i=e.replace(/^\//,"").split("/"),n=null,r=null;if(1===i.length)r=i[0],n=this.create(r);else{var o=i.splice(0,i.length-1).join("/");r=i[0],n=this.create(o)}Ee(n.nodes,t.nodes),t.name&&(n.name=t.name),n.nodes[""]&&(Object.keys(n.nodes[""]).forEach(function(e){"nodes"!==e&&(n[e]=n.nodes[""][e])}),Ee(n.nodes,n.nodes[""].nodes),delete n.nodes[""].nodes)};var Ie=l,Pe=/file:\/\//.test("object"==typeof window&&window.location&&window.location.origin),De=new RegExp("^(file://|/)(.*.html?/?)?"),Re=new RegExp("^(http(s)?(://))?(www.)?[a-zA-Z0-9-_.]+(:[0-9]{1,5})?(/{1})?"),Ge=new RegExp("#"),Me=new RegExp("[?].*$"),Ve=function(e){function t(e){return n?(e=function(e,t){return(e=Pe?e.replace(De,""):e.replace(Re,"")).replace(Me,"").replace(Ge,"/")}(e))===o?r():(o=e,(r=i(e))()):i(e)}var i=Ie((e=e||{}).default||"/404"),n=e.curry||!1,r=null,o=null;return t.router=i,t.on=function(e,t){e=e.replace(/^[#/]/,""),i.on(e,t)},t},qe=c,Be={};c.prototype.route=function(e,t){var i=this;this.router.on(e,function(n){return function(){i.state.params=n,i.state.route=e;var r=me("choo.route('"+e+"')"),o=t(i.state,function(e,t){i.emitter.emit(e,t)});return r(),o}})},c.prototype.use=function(e){var t="choo.use";t=e.storeName?t+"("+e.storeName+")":t;var i=me(t);e(this.state,this.emitter,this),i()},c.prototype.start=function(){var e=this;return this._historyEnabled&&(this.emitter.prependListener(this._events.NAVIGATE,function(){e.state.query=Te(window.location.search),e._loaded&&(e.emitter.emit(e._events.RENDER),setTimeout(function(e,t){if(e)try{var i=document.querySelector(e);i&&i.scrollIntoView(t)}catch(e){}}.bind(null,window.location.hash),0))}),this.emitter.prependListener(this._events.POPSTATE,function(){e.emitter.emit(e._events.NAVIGATE)}),this.emitter.prependListener(this._events.PUSHSTATE,function(t){window.history.pushState(Be,null,t),e.emitter.emit(e._events.NAVIGATE)}),this.emitter.prependListener(this._events.REPLACESTATE,function(t){window.history.replaceState(Be,null,t),e.emitter.emit(e._events.NAVIGATE)}),window.onpopstate=function(){e.emitter.emit(e._events.POPSTATE)},e._hrefEnabled&&function(e,t){t=t||window.document,window.addEventListener("click",function(i){if(!(i.button&&0!==i.button||i.ctrlKey||i.metaKey||i.altKey||i.shiftKey||i.defaultPrevented)){var n=function e(i){if(i&&i!==t)return"a"!==i.localName||void 0===i.href?e(i.parentNode):i}(i.target);n&&(window.location.origin!==n.origin||n.hasAttribute("download")||"_blank"===n.getAttribute("target")&&be.test(n.getAttribute("rel"))||we.test(n.getAttribute("href"))||(i.preventDefault(),e(n)))}})}(function(t){var i=t.href;i!==window.location.href&&e.emitter.emit(e._events.PUSHSTATE,i)})),this.state.href=this._createLocation(),this.state.query=Te(window.location.search),this._tree=this.router(this.state.href),this.emitter.prependListener(e._events.RENDER,function(e,t){t||(t=window.requestAnimationFrame);var i=!1,n=null;return function(){null!==n||i||(i=!0,t(function(){i=!1;for(var t=n.length,r=new Array(t),o=0;o<t;o++)r[o]=n[o];e.apply(e,r),n=null})),n=arguments}}(function(){var t=me("choo.render");e.state.href=e._createLocation();var i=e.router(e.state.href),n=me("choo.morph");Ne(e._tree,i),n(),t()})),ce(function(){e.emitter.emit(e._events.DOMCONTENTLOADED),e._loaded=!0}),this._tree},c.prototype.mount=function(e){var t=this;ce(function(){var i=me("choo.render"),n=t.start();t._tree=document.querySelector(e);var r=me("choo.morph");Ne(t._tree,n),r(),i()})},c.prototype.toString=function(e,t){return this.state=ke(this.state,t||{}),this.state.href=e.replace(/\?.+$/,""),this.state.query=Te(e),this.router(e).toString()};const je=[{title:"Atoms",view:()=>((e,t)=>V`
  ...
  `)("Atoms",ee)},{title:"Home",view:e=>V`
    <div class='bg-grey-1'>
      ${(({text:e,imgUrl:t,btnLink:i,btnText:n})=>V`
...
`)({quote:"She is more then just a health worker. She is like my mother.",quotee:"Aisah - Living Goods clicnet - Uganda",imgUrl:ae[3]})}
  ...
  `}],Ue=()=>{Fe("[data-in-view]");let e=0;window.document.addEventListener("scroll",()=>{(e+=1)%5==0&&Fe("[data-in-view]")})},Fe=e=>{document.querySelectorAll(e).forEach(e=>{const t=window.document.body.scrollTop+window.innerHeight,i=e.offsetTop||e.offsetParent.offsetTop;console.log({elmTop:i,scrollTop:t}),e.setAttribute("data-in-view",t>=i)})},We=qe();We.use((e,t)=>{t.on("setFonts",i=>{e.fontStyle=i,t.emit("render")}),t.on("DOMContentLoaded",Ue),t.on("render",Ue)}),We.route("*",(e,t)=>{const i=Number(e.query.tab||0);return V`
    <div>
